...
<div class="form-group">
					    <label class="info-title" for="email Address">Official email Address<span>*</span></label>
					    <textarea class="form-control unicase-form-control text-input" " name="emailaddress" required="required"><?php echo $row['billingAddress'];?></textarea>
					  </div>
<div class="form-group">
