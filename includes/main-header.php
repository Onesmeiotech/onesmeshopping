	...
	<a href="index.php">
		...
		<h2><div class="item">
					<a href="index.php" class="image">
						<img  border-radius="10px" width="150px" data-echo="brandsimage/og.png" src="assets/images/blank.gif" alt="">
					</a>	</h2>
	...
	?>
				...
				<div class="cart-item product-summary">
					<div class="row">
						...
						<div class="col-xs-7">
							...
							<div class="price">Rwf.<?php echo ($row['productPrice']+$row['shippingCharge']); ?>*<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?></div>
						</div>
			...
			<div class="clearfix cart-total">
				<div class="pull-right">
						...
						<span class="text">Total :</span><span class='price'>Rwf.<?php echo $_SESSION['tp']="$totalprice". ".00"; ?></span>
