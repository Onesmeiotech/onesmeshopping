...
<html lang="en">
	<head>
	    ...
	    <title>LUX Shopping PortIform Home Page</title>
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(assets/images/sliders/silayidi.jpg);">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
		<div class="full-width-slider">
		<div class="item" style="background-image:url(assets/images/sliders/sisi.jpg);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">you will Getting your order affter 3 days</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Products</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#USB" data-toggle="tab">Smart phones</a></li>
					<li><a href="#All-electronics" data-toggle="tab">mobile accessories</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
...
?>
	...
	<?php } ?>
		...
		<div class="tab-pane" id="All-electronics">
					<div class="product-slider">
						<div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
		<?php
$ret=mysqli_query($con,"select * from products where category=11");
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 id="none" class="section-title">Smart protector</h3>
	                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	   
<?php
$ret=mysqli_query($con,"select * from products where category=10 and subCategory=21");
while ($row=mysqli_fetch_array($ret)) 
{
?>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3  id="none" class="section-title">phone cover</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
$ret=mysqli_query($con,"select * from products where category=10 and subCategory=22");
while ($row=mysqli_fetch_array($ret)) 
{
?>
...
<?php }?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		<h3 id="none" class="section-title">Finger Ring logo</h3>
