...
<link rel="shortcut icon" href="../brandsimage/og.png">
	...
	<title>Admin| clients Orders</title>
...
{?>
									...
									<strong>Ohhhh fantastic!</strong> 	<?php echo htmlentities($_SESSION['delmsg']);?><?php echo htmlentities($_SESSION['delmsg']="");?>
									</div>
<?php } ?>
			...
			<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display table-responsive" >
									<thead>
										<tr>
											<th>#</th>
											<th> Name</th>
											<th width="30">Email /Contact no</th>
...
?>										
										<tr>
											...
											<td><a href="todays-orders.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="icon-remove-sign"></i></a></td>
											</tr>
